...
async function fetchFromMahaDBT() {
  ...
  const schemes = [
    ...
    {
      id: 'mahadbt-solar',
      titleEn: 'Solar Pump Subsidy Scheme',
      titleMr: 'सौर पंप अनुदान योजना',
      titleHi: 'सोलर पंप सब्सिडी योजना',
      descriptionEn: 'Subsidy for installation of solar-powered agricultural pumps to reduce electricity costs.',
      descriptionMr: 'वीज खर्च कमी करण्यासाठी सौर ऊर्जेवर चालणारे शेती पंप बसविण्यासाठी अनुदान.',
      descriptionHi: 'बिजली की लागत कम करने के लिए सौर ऊर्जा से चलने वाले कृषि पंप स्थापित करने के लिए सब्सिडी.',
      imageUrl: null,
      documentUrl: null,
      websiteUrl: 'https://mahadbt.maharashtra.gov.in',
      category: 'सबसिडी',
      eligibility: ['महाराष्ट्रातील शेतकरी', 'शेतीसाठी वीज कनेक्शन', 'किमान 1 हेक्टर जमीन'],
      benefits: ['3 HP पंप 90% अनुदान', '5 HP पंप 90% अनुदान', 'वीज बिल शून्य', '25 वर्षे वारंटी'],
      documents: ['आधार कार्ड', '7/12', 'वीज बिल', 'बँक खाते तपशील'],
      applicationProcess: 'MahaDBT पोर्टल वर ऑनलाइन अर्ज करा',
      deadline: null,
      isActive: true,
      source: 'mahadbt.maharashtra.gov.in',
    ...
    {
      id: 'mahadbt-baliraja',
      titleEn: 'Baliraja Krishi Yantra Anudan Yojana',
      titleMr: 'बलिराजा कृषी यंत्र अनुदान योजना',
      titleHi: 'बलिराजा कृषि यंत्र अनुदान योजना',
      descriptionEn: 'Subsidy on purchase of various agricultural implements and machinery.',
      descriptionMr: 'विविध कृषी अवजारे आणि यंत्रसामग्री खरेदीवर अनुदान.',
      descriptionHi: 'विभिन्न कृषि उपकरण और मशीनरी की खरीद पर सब्सिडी.',
      imageUrl: null,
      documentUrl: null,
      websiteUrl: 'https://mahadbt.maharashtra.gov.in',
      category: 'उपकरणे',
      eligibility: ['महाराष्ट्रातील शेतकरी', 'लहान/सीमांत/इतर शेतकरी', 'प्रथमच यंत्र खरेदी'],
      benefits: ['50% अनुदान (सामान्य)', '60% अनुदान (SC/ST)', 'विविध यंत्रांसाठी', 'कमाल ₹1 लाख'],
      documents: ['आधार कार्ड', '7/12', 'जात प्रमाणपत्र', 'बँक खाते तपशील', 'Quotation'],
      applicationProcess: 'MahaDBT पोर्टल वर ऑनलाइन अर्ज करा',
      deadline: null,
      isActive: true,
      source: 'mahadbt.maharashtra.gov.in',
